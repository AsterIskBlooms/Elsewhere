package team.lookingglass.constructure.registry.registryclasses;
...
public class AmethystPillarBlock extends RotatedPillarBlock {
    public static final MapCodec<net.minecraft.world.level.block.AmethystBlock> CODEC = simpleCodec(net.minecraft.world.level.block.AmethystBlock::new);
