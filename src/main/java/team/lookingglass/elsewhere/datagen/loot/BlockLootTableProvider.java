...
public class BlockLootTableProvider extends FabricBlockLootSubProvider {
    ...
    public void generate() {
        ...
        dropSelf(EBlocks.BLACKSTONE_PILLAR);
        ...
        dropSelf(EBlocks.DRIPSTONE_TILES);
        dropSelf(EBlocks.DRIPSTONE_TILE_STAIRS);
        add(EBlocks.DRIPSTONE_TILE_SLAB, createSlabItemTable(EBlocks.DRIPSTONE_TILE_SLAB));
        dropSelf(EBlocks.DRIPSTONE_TILE_WALL);
        dropSelf(EBlocks.CHISELED_DRIPSTONE_TILES);
        ...
        dropSelf(EBlocks.DARK_PRISMARINE_SCALES);
        dropSelf(EBlocks.DARK_PRISMARINE_SCALE_STAIRS);
        add(EBlocks.DARK_PRISMARINE_SCALE_SLAB, createSlabItemTable(EBlocks.DARK_PRISMARINE_SCALE_SLAB));
        dropSelf(EBlocks.DARK_PRISMARINE_SCALE_WALL);
        ...
        dropSelf(EBlocks.POLISHED_SMOOTH_BASALT);
        dropSelf(EBlocks.POLISHED_SMOOTH_BASALT_STAIRS);
        add(EBlocks.POLISHED_SMOOTH_BASALT_SLAB, createSlabItemTable(EBlocks.POLISHED_SMOOTH_BASALT_SLAB));
        dropSelf(EBlocks.POLISHED_SMOOTH_BASALT_WALL);
        dropSelf(EBlocks.SMOOTH_BASALT_BRICKS);
        dropSelf(EBlocks.SMOOTH_BASALT_BRICK_STAIRS);
        add(EBlocks.SMOOTH_BASALT_BRICK_SLAB, createSlabItemTable(EBlocks.SMOOTH_BASALT_BRICK_SLAB));
        dropSelf(EBlocks.SMOOTH_BASALT_BRICK_WALL);
        dropSelf(EBlocks.SMOOTH_BASALT_TILES);
        dropSelf(EBlocks.SMOOTH_BASALT_TILE_STAIRS);
        add(EBlocks.SMOOTH_BASALT_TILE_SLAB, createSlabItemTable(EBlocks.SMOOTH_BASALT_TILE_SLAB));
        dropSelf(EBlocks.SMOOTH_BASALT_TILE_WALL);
        ...
        dropSelf(EBlocks.PINK_SAND);
        dropSelf(EBlocks.PINK_SANDSTONE);
        dropSelf(EBlocks.PINK_SANDSTONE_STAIRS);
        add(EBlocks.PINK_SANDSTONE_SLAB, createSlabItemTable(EBlocks.PINK_SANDSTONE_SLAB));
        dropSelf(EBlocks.PINK_SANDSTONE_WALL);
        dropSelf(EBlocks.SMOOTH_PINK_SANDSTONE);
        dropSelf(EBlocks.SMOOTH_PINK_SANDSTONE_STAIRS);
        add(EBlocks.SMOOTH_PINK_SANDSTONE_SLAB, createSlabItemTable(EBlocks.SMOOTH_PINK_SANDSTONE_SLAB));
        dropSelf(EBlocks.SMOOTH_PINK_SANDSTONE_WALL);
        dropSelf(EBlocks.CUT_PINK_SANDSTONE);
        dropSelf(EBlocks.CUT_PINK_SANDSTONE_STAIRS);
        add(EBlocks.CUT_PINK_SANDSTONE_SLAB, createSlabItemTable(EBlocks.CUT_PINK_SANDSTONE_SLAB));
        dropSelf(EBlocks.CUT_PINK_SANDSTONE_WALL);
        dropSelf(EBlocks.POLISHED_PINK_SANDSTONE);
        dropSelf(EBlocks.POLISHED_PINK_SANDSTONE_STAIRS);
        add(EBlocks.POLISHED_PINK_SANDSTONE_SLAB, createSlabItemTable(EBlocks.POLISHED_PINK_SANDSTONE_SLAB));
        ...
        dropSelf(EBlocks.POPLAR_SHELF);
        dropSelf(EBlocks.POPLAR_SAPLING);
        add(EBlocks.POTTED_POPLAR_SAPLING, createPotFlowerItemTable(EBlocks.BLUEBONNET));
        ...
        dropSelf(EBlocks.AZALEA_SHELF);

        dropSelf(EBlocks.CEDAR_LOG);
        dropSelf(EBlocks.STRIPPED_CEDAR_LOG);
        dropSelf(EBlocks.CEDAR_WOOD);
        dropSelf(EBlocks.STRIPPED_CEDAR_WOOD);
        dropSelf(EBlocks.CEDAR_PLANKS);
        dropSelf(EBlocks.CEDAR_MOSAIC);
        dropSelf(EBlocks.CEDAR_BOARDS);
        dropSelf(EBlocks.CEDAR_TRIM);
        dropSelf(EBlocks.CEDAR_STAIRS);
        dropSelf(EBlocks.CEDAR_MOSAIC_STAIRS);
        dropSelf(EBlocks.CEDAR_FENCE);
        dropSelf(EBlocks.CEDAR_FENCE_GATE);
        add(EBlocks.CEDAR_SLAB, createSlabItemTable(EBlocks.CEDAR_SLAB));
        add(EBlocks.CEDAR_MOSAIC_SLAB, createSlabItemTable(EBlocks.CEDAR_MOSAIC_SLAB));
        add(EBlocks.CEDAR_DOOR, createDoorTable(EBlocks.CEDAR_DOOR));
        dropSelf(EBlocks.CEDAR_TRAPDOOR);
        dropSelf(EBlocks.CEDAR_PRESSURE_PLATE);
        dropSelf(EBlocks.CEDAR_BUTTON);
        dropOther(EBlocks.CEDAR_SIGN, EItems.CEDAR_SIGN);
        dropOther(EBlocks.CEDAR_WALL_SIGN, EItems.CEDAR_SIGN);
        dropOther(EBlocks.CEDAR_HANGING_SIGN, EItems.CEDAR_HANGING_SIGN);
        dropOther(EBlocks.CEDAR_WALL_HANGING_SIGN, EItems.CEDAR_HANGING_SIGN);
        dropSelf(EBlocks.CEDAR_SHELF);
        dropSelf(EBlocks.CEDAR_SAPLING);
        ...
        dropSelf(EBlocks.TERRACOTTA_BRICKS);
        dropSelf(EBlocks.TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.WHITE_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.WHITE_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.WHITE_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.WHITE_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.GRAY_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.GRAY_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.GRAY_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.GRAY_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.BLACK_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.BLACK_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.BLACK_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.BLACK_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.BROWN_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.BROWN_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.BROWN_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.BROWN_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.RED_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.RED_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.RED_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.RED_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.ORANGE_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.ORANGE_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.ORANGE_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.ORANGE_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.YELLOW_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.YELLOW_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.YELLOW_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.YELLOW_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.LIME_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.LIME_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.LIME_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.LIME_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.GREEN_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.GREEN_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.GREEN_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.GREEN_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.CYAN_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.CYAN_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.CYAN_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.CYAN_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.BLUE_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.BLUE_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.BLUE_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.BLUE_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.PURPLE_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.PURPLE_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.PURPLE_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.PURPLE_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.MAGENTA_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.MAGENTA_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.MAGENTA_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.MAGENTA_TERRACOTTA_BRICK_SLAB));
        dropSelf(EBlocks.PINK_TERRACOTTA_BRICKS);
        dropSelf(EBlocks.PINK_TERRACOTTA_BRICK_STAIRS);
        add(EBlocks.PINK_TERRACOTTA_BRICK_SLAB, createSlabItemTable(EBlocks.PINK_TERRACOTTA_BRICK_SLAB));

        dropSelf(EBlocks.TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.WHITE_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.WHITE_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.WHITE_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.WHITE_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.LIGHT_GRAY_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.GRAY_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.GRAY_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.GRAY_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.GRAY_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.BLACK_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.BLACK_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.BLACK_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.BLACK_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.BROWN_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.BROWN_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.BROWN_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.BROWN_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.RED_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.RED_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.RED_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.RED_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.ORANGE_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.ORANGE_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.ORANGE_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.ORANGE_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.YELLOW_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.YELLOW_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.YELLOW_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.YELLOW_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.LIME_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.LIME_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.LIME_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.LIME_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.GREEN_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.GREEN_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.GREEN_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.GREEN_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.CYAN_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.CYAN_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.CYAN_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.CYAN_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.LIGHT_BLUE_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.BLUE_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.BLUE_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.BLUE_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.BLUE_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.PURPLE_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.PURPLE_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.PURPLE_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.PURPLE_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.MAGENTA_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.MAGENTA_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.MAGENTA_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.MAGENTA_TERRACOTTA_BRICK_TILE_SLAB));
        dropSelf(EBlocks.PINK_TERRACOTTA_BRICK_TILES);
        dropSelf(EBlocks.PINK_TERRACOTTA_BRICK_TILE_STAIRS);
        add(EBlocks.PINK_TERRACOTTA_BRICK_TILE_SLAB, createSlabItemTable(EBlocks.PINK_TERRACOTTA_BRICK_TILE_SLAB));
