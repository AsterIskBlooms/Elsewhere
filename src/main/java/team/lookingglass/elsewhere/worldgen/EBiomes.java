...
public interface  EBiomes {
    ...
    static void bootstrap(BootstrapContext<Biome> context) {
        ...
        context.register(BOG, createBog(context));
        context.register(DAPPLED_FOREST, createDappledForest(context));
        context.register(CHERRY_FIELDS, createCherryFields(context));
        ...
        context.register(CLOUD_FOREST, createCloudForest(context));
    ...
    ResourceKey<Biome> BOG = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(Elsewhere.MODID, "bog"));
    ...
    ResourceKey<Biome> CHERRY_FIELDS = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(Elsewhere.MODID, "cherry_fields"));
    ...
    ResourceKey<Biome> CLOUD_FOREST = ResourceKey.create(Registries.BIOME, Identifier.fromNamespaceAndPath(Elsewhere.MODID, "cloud_forest"));
    ...
    private static Biome createBog(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        spawnBuilder.addSpawn(MobCategory.MONSTER, 75, new MobSpawnSettings.SpawnerData(EEntities.FROSTBITE, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 20, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 70, new MobSpawnSettings.SpawnerData(EntityType.BOGGED, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 30, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 10, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 1, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_VILLAGER, 1, 1));
        ...
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, EPlacedFeatures.SWAMP_CATTAILS);
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, EPlacedFeatures.SWAMP_GRASS);
    ...
    private static Biome createCherryFields(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();
        ...
        BiomeDefaultFeatures.addDefaultOres(genBuilder);
        BiomeDefaultFeatures.addDefaultSoftDisks(genBuilder);
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_GRASS_PLAIN);
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.FLOWER_CHERRY);
        BiomeDefaultFeatures.addNearWaterVegetation(genBuilder);

        genBuilder.addFeature(GenerationStep.Decoration.LOCAL_MODIFICATIONS, EPlacedFeatures.MEADOW_ROCK);
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, EPlacedFeatures.RUSTY_MOSS_PATCH);
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, EPlacedFeatures.SPARSE_CHERRY);
    ...
    private static Biome createSteppe(BootstrapContext<Biome> context) {
        ...
        BiomeDefaultFeatures.commonSpawns(spawnBuilder);
        spawnBuilder.addSpawn(MobCategory.CREATURE, 35, new MobSpawnSettings.SpawnerData(EntityType.HORSE, 2, 6));
        spawnBuilder.addSpawn(MobCategory.CREATURE, 80, new MobSpawnSettings.SpawnerData(EntityType.ARMADILLO, 2, 4));
    ...
    private static Biome createCloudForest(BootstrapContext<Biome> context) {
        MobSpawnSettings.Builder spawnBuilder = new MobSpawnSettings.Builder();

        spawnBuilder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.CREEPER, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SLIME, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 100, new MobSpawnSettings.SpawnerData(EntityType.SPIDER, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 75, new MobSpawnSettings.SpawnerData(EntityType.HUSK, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 20, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 80, new MobSpawnSettings.SpawnerData(EntityType.BOGGED, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 20, new MobSpawnSettings.SpawnerData(EntityType.SKELETON, 4, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 10, new MobSpawnSettings.SpawnerData(EntityType.ENDERMAN, 1, 4));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.WITCH, 1, 1));
        spawnBuilder.addSpawn(MobCategory.MONSTER, 5, new MobSpawnSettings.SpawnerData(EntityType.ZOMBIE_HORSE, 1, 1));
        ...
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_BUSH);
        BiomeDefaultFeatures.addWarmFlowers(genBuilder);
        genBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, VegetationPlacements.PATCH_GRASS_JUNGLE);
        ...
        genBuilder.addFeature(GenerationStep.Decoration.RAW_GENERATION, EPlacedFeatures.JUNGLE_SHRUBS);
        genBuilder.addFeature(GenerationStep.Decoration.RAW_GENERATION, EPlacedFeatures.WINDSWEPT_MAHOGANY);
        genBuilder.addFeature(GenerationStep.Decoration.RAW_GENERATION, EPlacedFeatures.DESERT_DIRT_PATCH);
        genBuilder.addFeature(GenerationStep.Decoration.RAW_GENERATION, EPlacedFeatures.MOSSY_MUD_PATCH);
    ...
    private static Biome createDefaultCaves(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .setAttribute(EnvironmentAttributes.FOG_COLOR, 0x323342)
    ...
    private static Biome createCrystalCaverns(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects(new BiomeSpecialEffects.Builder()
                        ...
                        .build())
                .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_DRIPSTONE_CAVES))
                .setAttribute(EnvironmentAttributes.FOG_COLOR, 0x48344d)
                .setAttribute(EnvironmentAttributes.FOG_END_DISTANCE, 512F)
    ...
    private static Biome createFrigidCaves(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects(new BiomeSpecialEffects.Builder()
                        ...
                        .build())
                .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_FROZEN_PEAKS))
                .setAttribute(EnvironmentAttributes.FOG_COLOR, 0xccf8ff)
                .setAttribute(EnvironmentAttributes.FOG_END_DISTANCE, 256F)
                .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, 0x050533)
                .setAttribute(EnvironmentAttributes.SNOW_GOLEM_MELTS, false)
                .mobSpawnSettings(spawnBuilder.build())
    ...
    private static Biome createVolcanicDepths(BootstrapContext<Biome> context) {
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects(new BiomeSpecialEffects.Builder()
                        ...
                        .build())
                .setAttribute(EnvironmentAttributes.BACKGROUND_MUSIC, new BackgroundMusic(SoundEvents.MUSIC_BIOME_BADLANDS))
                .setAttribute(EnvironmentAttributes.FOG_COLOR, 0x422619)
                .setAttribute(EnvironmentAttributes.WATER_FOG_COLOR, 0x041F33)
                .setAttribute(EnvironmentAttributes.FOG_END_DISTANCE, 256F)
                .setAttribute(EnvironmentAttributes.SNOW_GOLEM_MELTS, true)
                .mobSpawnSettings(spawnBuilder.build())
