...
public class QuickShieldModel extends Model<Unit> {
    private final ModelPart plate;
    private final ModelPart handle;

    public QuickShieldModel(final ModelPart root) {
    ...
    public static LayerDefinition createLayer() {
        ...
        root.addOrReplaceChild("plate", CubeListBuilder.create().texOffs(0, 0).addBox(-6.0F, -6.0F, -2.0F, 12.0F, 12.0F, 1.0F), PartPose.ZERO);
