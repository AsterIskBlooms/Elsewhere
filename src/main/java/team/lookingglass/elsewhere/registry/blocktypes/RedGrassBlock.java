...
public class RedGrassBlock extends SpreadingSnowyBlock implements BonemealableBlock {
    public static final MapCodec<RedGrassBlock> CODEC = simpleCodec(RedGrassBlock::new);
    public RedGrassBlock(BlockBehaviour.Properties properties) {
        super(properties, BlockIds.DIRT);
    }

    @Override
    protected MapCodec<RedGrassBlock> codec() {
        return CODEC;
    }
    ...
    public void performBonemeal(final ServerLevel level, final RandomSource random, final BlockPos pos, final BlockState state) {
        ...
        BlockState grass = EBlocks.SHORT_RED_GRASS.defaultBlockState();
        Optional<Holder.Reference<ConfiguredFeature<?, ?>>> grassFeature = level.registryAccess().lookupOrThrow(Registries.CONFIGURED_FEATURE)
                .get(EConfiguredFeatures.RED_GRASS);
