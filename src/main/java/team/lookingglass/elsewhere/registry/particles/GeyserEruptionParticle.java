...
public class GeyserEruptionParticle extends NoRenderParticle {
    ...
    protected GeyserEruptionParticle(
        ...
        this.lifetime = 20;
        this.plumeParticle = new GeyserParticleOptions(EParticles.GEYSER_PLUME, this.waterBlocks);
        this.baseParticle = new GeyserBaseParticleOptions(EParticles.GEYSER_BASE, this.waterBlocks, 1.5F);
        this.poofParticle = new GeyserBaseParticleOptions(EParticles.GEYSER_POOF, this.waterBlocks, 2.0F);
    }
